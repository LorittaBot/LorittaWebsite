(function(root, factory) {
  ...
  $receiver.append_gw00v9$('://');
  $receiver.append_gw00v9$(get_authority(this));
  ...
  function get_authority($receiver) {
    ...
    if ($receiver.user != null) {
      $receiver_0.append_gw00v9$(encodeURLParameter($receiver.user));
      if ($receiver.password != null) {
        $receiver_0.append_s8itvh$(58);
        $receiver_0.append_gw00v9$(encodeURLParameter($receiver.password));
      }
      $receiver_0.append_s8itvh$(64);
    }
    if ($receiver.specifiedPort === 0) {
      $receiver_0.append_gw00v9$($receiver.host);
    } else {
      $receiver_0.append_gw00v9$(get_hostWithPort($receiver));
    }
    return $receiver_0.toString();
  }
  function get_authority_0($receiver) {
    ...
    if ((tmp$ = $receiver.user) != null) {
      var tmp$_0;
      $receiver_0.append_gw00v9$(encodeURLParameter(tmp$));
      if ((tmp$_0 = $receiver.password) != null) {
        $receiver_0.append_gw00v9$(':');
        $receiver_0.append_gw00v9$(encodeURLParameter(tmp$_0));
      }
      $receiver_0.append_gw00v9$('@');
    }
    $receiver_0.append_gw00v9$($receiver.host);
    if ($receiver.port !== 0 && $receiver.port !== $receiver.protocol.defaultPort) {
      $receiver_0.append_gw00v9$(':');
      $receiver_0.append_gw00v9$($receiver.port.toString());
    }
    return $receiver_0.toString();
  }
