(function(root, factory) {
  ...
  var intercept = defineInlineFunction('ktor-utils.io.ktor.pipeline.intercept_1vle7l$', wrapFunction(function() {
  ...
  var use = defineInlineFunction('ktor-utils.io.ktor.util.use_mfy7iq$', function($receiver, block) {
  try {
    $receiver.lock();
    return block();
  } finally   {
  ...
  var chomp = defineInlineFunction('ktor-utils.io.ktor.util.chomp_xxkbvm$', wrapFunction(function() {
  ...
  var intercept_0 = defineInlineFunction('ktor-utils.io.ktor.util.pipeline.intercept_1vle7l$', wrapFunction(function() {
  var PipelineContext = _.io.ktor.util.pipeline.PipelineContext;
  var COROUTINE_SUSPENDED = Kotlin.kotlin.coroutines.intrinsics.COROUTINE_SUSPENDED;
  var CoroutineImpl = Kotlin.kotlin.coroutines.CoroutineImpl;
  function Coroutine$intercept$lambda(typeClosure$TSubject_0, isTSubject_0, closure$block_0, $receiver_0, subject_0, controller, continuation_0) {
  ...
  function startCoroutineUninterceptedOrReturn3($receiver, receiver, arg, continuation) {
    var tmp$;
    var function_0 = typeof (tmp$ = $receiver) === 'function' ? tmp$ : throwCCE();
    return function_0(receiver, arg, continuation);
  }
  ...
  do try {
    switch (this.state_0) {
      case 0:
        ...
        this.state_0 = 2;
        this.result_0 = asDeferred(crypto.subtle.digest(this.$this.closure$name, snapshot)).await(this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 1:
  ...
  package$pipeline_0.Pipeline_init_phk9fc$ = Pipeline_init;
  ...
  Kotlin.defineModule('ktor-utils', _);
  return _;
}));
