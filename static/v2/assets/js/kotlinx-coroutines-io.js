(function(root, factory) {
  ...
  do try {
    switch (this.state_0) {
      case 0:
        this.state_0 = 2;
        this.result_0 = copyTo(this.local$$receiver, this.local$dst, void 0, this);
  ...
  function writePacket($receiver_0, headerSizeHint_0, builder_1, continuation) {
  ...
  if (Kotlin.isType(t_0, Throwable)) {
    ...
    return $receiver_0.writePacket_8awntw$(buildPacket$result_0, continuation);
  }
  ...
  do try {
    switch (this.state_0) {
      case 0:
        var tmp$, tmp$_0;
        this.state_0 = 2;
        this.result_0 = joinTo(Kotlin.isType(tmp$ = this.local$$receiver, ByteChannelSequentialBase) ? tmp$ : throwCCE(), Kotlin.isType(tmp$_0 = this.local$dst, ByteChannelSequentialBase) ? tmp$_0 : throwCCE(), this.local$closeOnEnd, this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 1:
