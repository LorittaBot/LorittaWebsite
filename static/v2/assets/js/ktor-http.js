(function(root, factory) {
  ...
  var encodeBase64 = $module$ktor_utils.io.ktor.util.encodeBase64_pdl1vz$;
  var decodeBase64 = $module$ktor_utils.io.ktor.util.decodeBase64_pdl1vz$;
  var isWhitespace = Kotlin.kotlin.text.isWhitespace_myv2d0$;
  var wrapFunction = Kotlin.wrapFunction;
  var Month = $module$ktor_utils.io.ktor.util.date.Month;
  var GMTDate = $module$ktor_utils.io.ktor.util.date.GMTDate_qlqxlw$;
  ...
  var StringValuesSingleImpl = $module$ktor_utils.io.ktor.util.StringValuesSingleImpl;
  ...
  var contains_0 = $module$ktor_utils.io.ktor.util.contains_9p7nab$;
  ...
  var generateNonce = $module$ktor_utils.io.ktor.util.generateNonce;
  ...
  function parseServerSetCookieHeader(cookiesHeader) {
    ...
    var destination = LinkedHashMap_init_0(mapCapacity(asMap.size));
    var tmp$_13;
  ...
  var get_ExceptionFailed = defineInlineFunction('ktor-http.io.ktor.http.get_ExceptionFailed_i80ybi$', function($receiver) {
  ...
  var flatten = defineInlineFunction('ktor-http.io.ktor.http.parsing.flatten_mtaoqd$', wrapFunction(function() {
  var Unit = Kotlin.kotlin.Unit;
  var wrapFunction = Kotlin.wrapFunction;
  var flatten$lambda = wrapFunction(function() {
  var addAll = Kotlin.kotlin.collections.addAll_ipc267$;
  ...
  Kotlin.defineModule('ktor-http', _);
  return _;
}));
