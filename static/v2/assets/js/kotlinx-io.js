(function(root, factory) {
  ...
  if (remaining.toNumber() > 0 && Kotlin.Long.fromInt(max).compareTo_11rb$(remaining) >= 0) 
    return readTextExactBytes(this, void 0, remaining.toInt());
  ...
  function readTextExact($receiver, charset, n) {
    if (charset === void 0) 
      charset = Charsets_getInstance().UTF_8;
    var s = readText_2($receiver, charset, n);
    if (s.length < n) 
  ...
  if (!(n >= 0)) {
    var m = new require$ObjectLiteral_1(IoBuffer$discardExact$lambda(n));
    m.doFail();
  }
